...
func main() {
	...
	// Android installs executable native code in ApplicationInfo.nativeLibraryDir.
	if androidLibDir := os.Getenv("MAAYYS_NATIVE_LIB_DIR"); androidLibDir != "" {
		libDir = androidLibDir
	}
	log.Info().
		Str("libDir", libDir).
